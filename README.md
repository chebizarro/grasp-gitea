...
USER_UID=1000                    # required; match Gitea's non-root git uid
USER_GID=1000                    # required; match Gitea's non-root git gid
GITEA_REPO_OWNERSHIP_AUTO_REPAIR=false # explicit one-shot whole-repo repair
